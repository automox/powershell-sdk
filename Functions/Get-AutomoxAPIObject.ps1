...
Function Get-AutomoxAPIObject
    {
        <#
          ...
          .NOTES
          The specified organization ID will be automatically appended to the end of any request URL, so it is unnecessary to add it manually.
              ...
              Try
                {
                    ...
                    $RegexExpressionDictionary = New-Object -TypeName 'System.Collections.Generic.Dictionary[[String], [System.Text.RegularExpressions.Regex]]'
                      ...
                      $RegexExpressionDictionary.PolicyUUID = '[{]?[0-9a-fA-F]{8}-([0-9a-fA-F]{4}-){3}[0-9a-fA-F]{12}[}]?'
                                                                                  ...
                                                                                  Switch ($InvokeWebRequestResult.StatusCode)
                                                                                    {
                                                                                                                ...
                                                                                                                {($_ -eq $True)}
                                                                                                                  {
                                                                                                                      ...
                                                                                                                      Switch ($InvokeWebRequestResponseRecordList.PSObject.Properties.Name -icontains 'metadata')
                                                                                                                        {
                                                                                                                            {($_ -eq $True)}
                                                                                                                              {
                                                                                                                                        ...
                                                                                                                                        {($_ -eq $True)}
                                                                                                                                          {
                                                                                                                                              ...
                                                                                                                                              $CurrentAPIRequestPage = $InvokeWebRequestResponseRecordList.Metadata.current_page
                                                                                        ...
                                                                                        {($_ -in @(429))}
                                                                                          {
                                                                                              [System.TimeSpan]$CountdownDuration = [System.TimeSpan]::FromSeconds(62)

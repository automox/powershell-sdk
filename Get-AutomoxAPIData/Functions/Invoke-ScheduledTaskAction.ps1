...
Function Invoke-ScheduledTaskAction
    {
        <#
          ...
          A valid scheduled task definition. The scheduled task definition can be defined directly within a powershell script or read from a file external to the powershell script.
          ...
          A valid scheduled task folder. If the scheduled taskfolder does not exist, it will be created. If the scheduled taskfolder does exist, it will NOT be removed upon removal of the scheduled task.
          ...
          A valid file name the script that will be executed by the scheduled task. A proper command line to execute the script will be dynamically generated based on the file extension.
          ...
          {           
              Try
                {  
                    ...
                    $GetScheduledTaskListResult.StandardOutput = $Process.StandardOutput.ReadToEndAsync()
                    $GetScheduledTaskListResult.StandardError = $Process.StandardError.ReadToEndAsync()
                          ...
                          {($_ -eq $True)}
                            {
                                ...
                                $ScheduledTaskList = $GetScheduledTaskListResult.StandardOutput.Result | ConvertFrom-CSV -Delimiter ',' | Where-Object {($_.TaskName -inotmatch '(^TaskName$)')} | Sort-Object -Property @('TaskName') -Unique
                                                                    ...
                                                                    Switch ($ScriptSourcePath.Extension)
                                                                      {
                                                                          ...
                                                                          {($_ -iin @('.vbs', '.wsf'))}
                                                                            {
                                                                                Switch ($Interactive.IsPresent)
                                                                                  {
                                                                                      {($_ -eq $True)}
                                                                                        {
                                                                                            $CommandNodeValue = "`"$([System.Environment]::SystemDirectory)\wscript.exe`""
                                                              ...
                                                              {($_ -eq $True)}
                                                                {
                                                                    ...
                                                                    $Null = Try {[System.IO.File]::Delete($ScheduledTaskDefinitionPath.FullName)} Catch {}
                                                                }
                                                          }
                                                    }
                                                              ...
                                                              {($_ -eq $True)}
                                                                {
                                                                    ...
                                                                    $Null = Try {[System.IO.Directory]::Delete($Source.FullName, $True)} Catch {}
                                                                }
                                                          }    
                                                    }
